...
1. 연구과제명
분할 소유권 거래소 기능을 위한 블록체인 기술

2. 연구 개발의 목표 및 내용
•	목표: 고가의 미술품과 같은 자산을 분할 소유할 수 있도록 하는 블록체인 기반의 거래소 개발. 이 거래소는 투명성, 보안성, 그리고 높은 유동성을 제공하여, 다양한 투자자가 접근할 수 있는 시장을 창출하는 것을 목표로 합니다.
•	내용:
•	블록체인 기술을 활용하여 미술품 등의 고가 자산을 분할하여 소유할 수 있는 플랫폼 개발.
•	분할된 소유권을 토큰화하여 거래할 수 있는 시스템 설계 및 구현.
•	스마트 계약을 사용하여 거래의 자동화와 보안을 강화.
•	거래소 사용자들에게 신뢰성 높은 거래 경험을 제공하기 위한 시스템 테스트 및 검증.
